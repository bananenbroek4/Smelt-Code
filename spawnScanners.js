...
var SpawnScanners =
{
	Execute : function(smelt)
	{
		...
		for(var i = startX; i<=endX; i++)
		{
			...
			{
				smelt.addCommandBlock(util.format('/execute %s ~ ~ ~ /summon area_effect_cloud ~%s %s ~%s %s', entitySelector, i, height, j, entityTags),{type:"chain",auto:true,conditional:false});
			}
		}
	}
}
